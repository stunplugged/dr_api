...
\newcommand{\ele}[1]{\emph{#1}} %formatering for felter
...
\chapter{Undersøgelse af XML dokumenterne}\label{chapter:study-xml-documents}
\input{text/study-xml-documents}

\chapter{Validering af XML dokumenterne}\label{chapter:xml-schemas}
\input{text/xml-schemas}

\chapter{XQuery søgning}\label{chapter:xquery-search}
\input{text/xquery-search}

\chapter{Fuld tekst søgning}\label{chapter:full-text-search}
