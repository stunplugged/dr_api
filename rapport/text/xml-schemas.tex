...
Ved undersøgelse af XML dokumenterne fremgik det at begge XML dokumenter indeholder en sekvens af enten videoer eller programserier. Derfor består første del af begge de udarbejde XML skemaer af en sekvens af enten elementet ProgramSerieVideo eller elementet ProgramSerie, som kan forekomme uendeligt mange gange. Både elementet \ele{ProgramSerieVideo} og \ele{ProgramSerie} er oprettet som et complexType element, der består af hver sine beskrivende elementer, som fx \ele{Slug}, \ele{Title}, \ele{Description} osv. Disse elementer som beskriver videoen eller programserien er blevet sat til at være af en bestemt type. Valget af type til elementerne er fremkommet dels af elements navn og elements indhold, som har givet et hint om hvilke type der er tale om.

Specielt skal det bemærkes at elementet \ele{BroadcastTime} i \ele{ProgramSerieVideo} er sat til at kunne forekommer i XML dokumentet med en null værdi (nillable). Det vil sige at en enkelt video kan have elementet \ele{BroadcastTime} i sig, men uden nogen værdi. En anden speciel detalje er at elementet \ele{BroadcastChannel} i \ele{ProgramSerieVideo}, er sat til at kunne undlades helt i en video. Dette gælder øvrigt også ShortName, WebCmsImagePath i skemaet til ProgramSeries.

I skemaet til programseries.xml er det også værd at bemærke element \ele{LabelsType}, som er et complexType element, som indgår i et andet complexType element, nemlig elementet \ele{ProgramSerieType}.  
...
Valideringen af XML dokumenterne med XML skemaerne er test ved hjælp af BaseX, som det ses i figur \ref{xschema:validering}, hvor validate:xsd er blevet anvendt. For at teste at XML skemaerne holder over tid, så er der igennem projektets forløb blevet hentet nye versioner af XML dokumenterne, som også har bestået valideringstesten med de udarbejde XML skemaer. 
