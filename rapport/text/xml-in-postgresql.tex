...
Til videoapplikationen skal der som tidligere nævnt bruges en funktion, som kan give et resultatsæt af at programserier inden for en given kategori, altså med en specifik label. Til det formål er funktionen ”programseriesOfLabel()” implementeret. 
