...
\begin{enumerate}
	...
	\item Kør skriptet som opretter alle tabeller.
	\begin{verbatim}
	create_tables.sql
	\end{verbatim}

	\item Kør skriptet for at kopierer XML indhold i databasen.
	\begin{verbatim}
	insert-XMLinto-downloadedXML.sql
	\end{verbatim}	

	\item Kør skriptet for at installere alle funktioner.
	\begin{verbatim}
	functions.sql
	\end{verbatim}	

	\item Kør skriptet for at opdatere forskellige tabeller.
	\begin{verbatim}
	CREATE_ALL_DATA.sql
	\end{verbatim}	
